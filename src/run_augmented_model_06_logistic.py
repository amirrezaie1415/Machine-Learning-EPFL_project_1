...
fileDir = os.path.dirname(os.path.abspath('run_augmented_model_05_logistic.py'))
...
# find features in which there is at least one value equal to 0 or 1.
features_contaning_zeros_0_1 = np.concatenate((np.unique(np.where(X_val_0 == 0)[1]), np.unique(np.where(X_tr_0 == 0)[1])))
features_contaning_zeros_0_2 = np.concatenate((np.unique(np.where(X_val_0 == 1.)[1]), np.unique(np.where(X_tr_0 == 1.)[1])))
features_contaning_zeros_0 = np.unique(np.concatenate((features_contaning_zeros_0_1, features_contaning_zeros_0_2)))

features_contaning_zeros_1_1 = np.concatenate((np.unique(np.where(X_val_1 == 0)[1]), np.unique(np.where(X_tr_1 == 0)[1])))
features_contaning_zeros_1_2 = np.concatenate((np.unique(np.where(X_val_1 == 1.)[1]), np.unique(np.where(X_tr_1 == 1.)[1])))
features_contaning_zeros_1 = np.unique(np.concatenate((features_contaning_zeros_1_1, features_contaning_zeros_1_2)))

features_contaning_zeros_2_1 = np.concatenate((np.unique(np.where(X_val_2 == 0)[1]), np.unique(np.where(X_tr_2 == 0)[1])))
features_contaning_zeros_2_2 = np.concatenate((np.unique(np.where(X_val_2 == 1.)[1]), np.unique(np.where(X_tr_2 == 1.)[1])))
features_contaning_zeros_2 = np.unique(np.concatenate((features_contaning_zeros_2_1, features_contaning_zeros_2_2)))

features_contaning_zeros_3_1 = np.concatenate((np.unique(np.where(X_val_3 == 0)[1]), np.unique(np.where(X_tr_3 == 0)[1])))
features_contaning_zeros_3_2 = np.concatenate((np.unique(np.where(X_val_3 == 1.)[1]), np.unique(np.where(X_tr_3 == 1.)[1])))
features_contaning_zeros_3 = np.unique(np.concatenate((features_contaning_zeros_3_1, features_contaning_zeros_3_2)))

# Augmenting data using inverse of log function.
X_tr_aug_0, X_val_aug_0 = build_log_inverse(X_tr_0, features_contaning_zeros_0), build_log_inverse(X_val_0, features_contaning_zeros_0)
X_tr_aug_1, X_val_aug_1 = build_log_inverse(X_tr_1, features_contaning_zeros_1), build_log_inverse(X_val_1, features_contaning_zeros_1)
X_tr_aug_2, X_val_aug_2 = build_log_inverse(X_tr_2, features_contaning_zeros_2), build_log_inverse(X_val_2, features_contaning_zeros_2)
X_tr_aug_3, X_val_aug_3 = build_log_inverse(X_tr_3, features_contaning_zeros_3), build_log_inverse(X_val_3, features_contaning_zeros_3)
...
X_tr_stan_0, X_val_stan_0 = standardize(X_tr_aug_0, X_val_aug_0)
X_tr_stan_1, X_val_stan_1 = standardize(X_tr_aug_1, X_val_aug_1)
X_tr_stan_2, X_val_stan_2 = standardize(X_tr_aug_2, X_val_aug_2)
X_tr_stan_3, X_val_stan_3 = standardize(X_tr_aug_3, X_val_aug_3)
...
# Augmenting data using using inverse of log function.
X_tr_aug_0, X_test_0 = build_log_inverse(X_tr_0, features_contaning_zeros_0), build_log_inverse(X_test_0, features_contaning_zeros_0)
X_tr_aug_1, X_test_1 = build_log_inverse(X_tr_1, features_contaning_zeros_1), build_log_inverse(X_test_1, features_contaning_zeros_1)
X_tr_aug_2, X_test_2 = build_log_inverse(X_tr_2, features_contaning_zeros_2), build_log_inverse(X_test_2, features_contaning_zeros_2)
X_tr_aug_3, X_test_3 = build_log_inverse(X_tr_3, features_contaning_zeros_3), build_log_inverse(X_test_3, features_contaning_zeros_3)

# test set is standardized (z-score normalization).
_, X_test_0 = standardize(X_tr_aug_0, X_test_0)
_, X_test_1 = standardize(X_tr_aug_1, X_test_1)
_, X_test_2 = standardize(X_tr_aug_2, X_test_2)
_, X_test_3 = standardize(X_tr_aug_3, X_test_3)
...
OUTPUT_PATH = os.path.join(parentDir, 'data/submission_augmented_model_06_logistic.csv')
