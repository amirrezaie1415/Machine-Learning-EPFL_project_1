...
fileDir = os.path.dirname(os.path.abspath('run_augmented_model_04_logistic.py'))
...
# Augmenting data using ratios between features.
X_tr_aug_0, X_val_aug_0 = ratios(X_tr_0, features_contaning_zeros_0), ratios(X_val_0, features_contaning_zeros_0)
X_tr_aug_1, X_val_aug_1 = ratios(X_tr_1, features_contaning_zeros_1), ratios(X_val_1, features_contaning_zeros_1)
X_tr_aug_2, X_val_aug_2 = ratios(X_tr_2, features_contaning_zeros_2), ratios(X_val_2, features_contaning_zeros_2)
X_tr_aug_3, X_val_aug_3 = ratios(X_tr_3, features_contaning_zeros_3), ratios(X_val_3, features_contaning_zeros_3)
...
# Augmenting data using using ratios between features.
X_tr_aug_0, X_test_0 = ratios(X_tr_0, features_contaning_zeros_0), ratios(X_test_0, features_contaning_zeros_0)
X_tr_aug_1, X_test_1 = ratios(X_tr_1, features_contaning_zeros_1), ratios(X_test_1, features_contaning_zeros_1)
X_tr_aug_2, X_test_2 = ratios(X_tr_2, features_contaning_zeros_2), ratios(X_test_2, features_contaning_zeros_2)
X_tr_aug_3, X_test_3 = ratios(X_tr_3, features_contaning_zeros_3), ratios(X_test_3, features_contaning_zeros_3)
...
OUTPUT_PATH = os.path.join(parentDir, 'data/submission_augmented_model_04_logistic.csv')
