...
fileDir = os.path.dirname(os.path.abspath('run_augmented_model_02_logistic.py'))
...
# Augmenting data using square root function.
X_tr_aug_0, X_val_aug_0 = build_sqrt(X_tr_0), build_sqrt(X_val_0)
X_tr_aug_1, X_val_aug_1 = build_sqrt(X_tr_1), build_sqrt(X_val_1)
X_tr_aug_2, X_val_aug_2 = build_sqrt(X_tr_2), build_sqrt(X_val_2)
X_tr_aug_3, X_val_aug_3 = build_sqrt(X_tr_3), build_sqrt(X_val_3)
...
# Augmenting data using square root function.
X_tr_aug_0, X_test_0 = build_sqrt(X_tr_0), build_sqrt(X_test_0)
X_tr_aug_1, X_test_1 = build_sqrt(X_tr_1), build_sqrt(X_test_1)
X_tr_aug_2, X_test_2 = build_sqrt(X_tr_2), build_sqrt(X_test_2)
X_tr_aug_3, X_test_3 = build_sqrt(X_tr_3), build_sqrt(X_test_3)
...
OUTPUT_PATH = os.path.join(parentDir, 'data/submission_augmented_model_02_logistic.csv')
