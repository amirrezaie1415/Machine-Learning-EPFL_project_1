...
fileDir = os.path.dirname(os.path.abspath('run_augmented_model_03_logistic.py'))
...
# Augmenting data using differences between features.
X_tr_aug_0, X_val_aug_0 = differences(X_tr_0), differences(X_val_0)
X_tr_aug_1, X_val_aug_1 = differences(X_tr_1), differences(X_val_1)
X_tr_aug_2, X_val_aug_2 = differences(X_tr_2), differences(X_val_2)
X_tr_aug_3, X_val_aug_3 = differences(X_tr_3), differences(X_val_3)
...
# Augmenting data using using differences between features.
X_tr_aug_0, X_test_0 = differences(X_tr_0), differences(X_test_0)
X_tr_aug_1, X_test_1 = differences(X_tr_1), differences(X_test_1)
X_tr_aug_2, X_test_2 = differences(X_tr_2), differences(X_test_2)
X_tr_aug_3, X_test_3 = differences(X_tr_3), differences(X_test_3)
...
OUTPUT_PATH = os.path.join(parentDir, 'data/submission_augmented_model_03_logistic.csv')
