...
# find features in which there is at least one value equal to 0.
features_contaning_zeros_0 = np.concatenate((np.unique(np.where(X_val_0 == 0)[1]), np.unique(np.where(X_tr_0 == 0)[1])))
features_contaning_zeros_1 = np.concatenate((np.unique(np.where(X_val_1 == 0)[1]), np.unique(np.where(X_tr_1 == 0)[1])))
features_contaning_zeros_2 = np.concatenate((np.unique(np.where(X_val_2 == 0)[1]), np.unique(np.where(X_tr_2 == 0)[1])))
features_contaning_zeros_3 = np.concatenate((np.unique(np.where(X_val_3 == 0)[1]), np.unique(np.where(X_tr_3 == 0)[1])))

# Augmenting data using log function.
X_tr_aug_0, X_val_aug_0 = build_log(X_tr_0, features_contaning_zeros_0), build_log(X_val_0, features_contaning_zeros_0)
X_tr_aug_1, X_val_aug_1 = build_log(X_tr_1, features_contaning_zeros_1), build_log(X_val_1, features_contaning_zeros_1)
X_tr_aug_2, X_val_aug_2 = build_log(X_tr_2, features_contaning_zeros_2), build_log(X_val_2, features_contaning_zeros_2)
X_tr_aug_3, X_val_aug_3 = build_log(X_tr_3, features_contaning_zeros_3), build_log(X_val_3, features_contaning_zeros_3)
...
# Augmenting data using using log function.
X_tr_aug_0, X_test_0 = build_log(X_tr_0, features_contaning_zeros_0), build_log(X_test_0, features_contaning_zeros_0)
X_tr_aug_1, X_test_1 = build_log(X_tr_1, features_contaning_zeros_1), build_log(X_test_1, features_contaning_zeros_1)
X_tr_aug_2, X_test_2 = build_log(X_tr_2, features_contaning_zeros_2), build_log(X_test_2, features_contaning_zeros_2)
X_tr_aug_3, X_test_3 = build_log(X_tr_3, features_contaning_zeros_3), build_log(X_test_3, features_contaning_zeros_3)
...
OUTPUT_PATH = os.path.join(parentDir, 'data/submission_augmented_model_05_logistic.csv')
